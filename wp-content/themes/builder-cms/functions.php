...
if (!function_exists('flex_theme_load_initial_css')) {
  ...
  {
    wp_register_style('flex_initial_css_main', get_template_directory_uri() . '/css/lg.css', array('flex-idx-main-project'));
...
function idx_footer_customizaer()
{
  ...
  if (empty(get_option('idxboost_themes_custom')['idx_difuminacion_home'])) $idx_difuminacion_home = 'transparent';
  else $idx_difuminacion_home = get_option('idxboost_themes_custom')['idx_difuminacion_home'];
  if (empty(get_option('idxboost_themes_custom')['idx_difuminacion_inner_pages'])) $idx_difuminacion_inner_pages = 'transparent';
  else $idx_difuminacion_inner_pages = get_option('idxboost_themes_custom')['idx_difuminacion_inner_pages'];
  if (empty(get_theme_mod('idxboost_themes_custom')['color_home'])) $color_home = '';
  else  $color_home = get_theme_mod('idxboost_themes_custom')['color_home'];
  if (empty(get_theme_mod('idxboost_themes_custom')['color_inner_pages'])) $color_inner_pages = '';
  else  $color_inner_pages = get_theme_mod('idxboost_themes_custom')['color_inner_pages'];
...
function get_custom_logo_footer($nameFooter = 0)
{
  ...
  if ($idx_theme_broker) {
    ...
    $html = sprintf(
      '<a href="%1$s" class="' . $nameFooter . '" style="display:none;"><img /></a>',
      esc_url(home_url('/'))
    );
  }
...
function get_custom_logo_header()
{
  ...
  if (get_option('idx_site_radio_sta') == 'text') {
    ...
    if (empty(get_theme_mod('idx_site_text_slogan'))) $idx_site_text_slogan = '';
...
*/
  ...
  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'idxboost_themes_custom[color_home]', array(
...
function get_custom_logo_header_boots()
{
  ...
  if (get_option('idx_site_radio_sta') == 'text') {
    if (empty(get_theme_mod('idx_site_text')))  $idx_site_text  = '';
    else  $idx_site_text  = get_theme_mod('idx_site_text');
    if (empty(get_theme_mod('idx_site_text_slogan'))) $idx_site_text_slogan = '';
    else  $idx_site_text_slogan = get_theme_mod('idx_site_text_slogan');
    ...
    if (empty(get_theme_mod('idx_image_logo')))  $idx_theme_broker  = '';
    else  $idx_theme_broker  = get_theme_mod('idx_image_logo');
    if (empty(get_theme_mod('idx_image_logo_interior')))  $idx_image_logo_interior  = $idx_theme_broker;
    else  $idx_image_logo_interior  = get_theme_mod('idx_image_logo_interior');
