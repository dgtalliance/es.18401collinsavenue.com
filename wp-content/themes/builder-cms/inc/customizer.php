<?php
/**
 * Builder CMS Customizer functionality
 *
 * @package WordPress
...
/**
 * Register color schemes for Builder CMS.
 *
...
function twentyfifteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Builder CMS.
	 *
...
/**
 * Get the current Builder CMS color scheme.
 *
 * @since Builder CMS 1.0
 *
...
/**
 * Returns an array of color scheme choices registered for Builder CMS.
 *
 * @since Builder CMS 1.0
 *
